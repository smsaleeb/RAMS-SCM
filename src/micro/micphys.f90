...
!SaleebySCM:Flags to control which microphysics processes to run. Can turn them
!on or off in the namelist
integer :: ivapdiff,iautoaccret,icldrime,iselfcollragh,iselfcollps &
 ,icollps,icolliceice,icollicerain,imelting,icldnuc,iicenuc &
 ,isedimentation,inegadj,initcustom,ithermo

!SaleebySCM:Dust fraction database variables
real, dimension(360,180) :: ginoux_1p00_deg_dustfrac
...
integer :: level,icloud,idriz,irain,ipris,isnow,iaggr,igraup,ihail     &
  ...
  ,iaeroprnt,iaerohist,iifn_formula,ipress,itheta,irv,numsteps,writescm
